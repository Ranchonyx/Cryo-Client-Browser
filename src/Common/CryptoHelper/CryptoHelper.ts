...
export class PerSessionCryptoHelper {
    ...
    */
    ...
    public constructor(private send_key: CryptoKey, private recv_key: CryptoKey, private log = CreateDebugLogger("CRYO_CRYPTO")) {
    }
    ...
    public async decrypt(cipher: CryoBuffer): Promise<Uint8Array> {
